<?php $this->layout('layout3', ['title' => 'Document']) ?>
    ...
    <main id="js-page-content" role="main" class="page-content mt-3">
        ...
        <form action="/create_user_edit" method="post" enctype="multipart/form-data">
            <div class="row">
                <div class="col-xl-6">
                        ...
                        <div class="panel-container">
                            ...
                            <div class="panel-content">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="adress" id="simpleinput" class="form-control">
                                </div>
                            </div>
                        </div>
